...
Writes: ksbody/web/config/process_step_lookup.json
"""
...
OUTPUT_PATH = REPO_ROOT / "ksbody" / "web" / "config" / "process_step_lookup.json"
...
def build_lookup(csv_path: Path) -> dict[str, dict]:
    ...
    with csv_path.open(encoding="utf-8-sig") as fh:
        ...
        for row in reader:
            ...
            tunable = None if not tunable_raw else tunable_raw.lower() not in {"false", "0", "no"}
